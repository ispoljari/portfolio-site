...
const Heroku = () => (
  <svg 
    ...
    version="1.1"
    role="img" 
    aria-labelledby="heroku-icon-svg" 
  >
    <title
      id="heroku-icon-svg"
    >
